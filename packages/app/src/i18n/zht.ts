...
export const dict = {
  ...
  "settings.models.description": "設定模型顯示方式與此伺服器的預設模型。",
  "settings.models.default": "預設",
  "settings.models.setDefault": "設為預設",
  "settings.models.defaultUpdated": "預設模型已更新",
  "settings.models.defaultUpdateFailed": "更新預設模型失敗",
