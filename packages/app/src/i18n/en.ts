...
export const dict = {
  ...
  "settings.models.description": "Configure model visibility and the default model for this server.",
  "settings.models.default": "Default",
  "settings.models.setDefault": "Set as default",
  "settings.models.defaultUpdated": "Default model updated",
  "settings.models.defaultUpdateFailed": "Failed to update default model",
